...
/**
 * ExportMdModal component
 * Generates and exports Markdown documentation with Clockify report data
 * Supports: Burndown, Velocity, Retro, Dedication templates
 *
 * @param {Object} report - Clockify report data
 * @param {number} sprint - Sprint number (1-3)
...
export default function ExportMdModal({ report, sprint, onClose }) {
  ...
  function genDedication() {
    ...
    return [
      ...
      `---`,
      `*Este informe ha sido generado automáticamente integrando datos de Clockify y el estado del Backlog en GitHub.*`,
    ].join('\n');
  }
